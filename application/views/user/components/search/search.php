...
<section class="product-content clearfix">
    <h1 class="title clearfix"><span>Xe</span></h1>
    <div class="product-block product-grid clearfix">
    <?php
        $keyword = $this->uri->segment(2);
        if($this->admin_model->total_search_by_fulltext($keyword) > 0){
            $config['total_rows'] = $this->admin_model->total_search_by_fulltext($keyword);
            $config['per_page'] = 8;
            ...
            $vehicle = $this->admin_model->pagination_search_by_fulltext($keyword, $config['per_page'], $page);

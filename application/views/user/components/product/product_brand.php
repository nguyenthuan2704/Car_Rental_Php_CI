<?php
    ...
    $vehicle_brand = $this->vehicle_model->get_brand_by_id($vehicle_brand_id);
?>
...
<section class="product-content clearfix">
    <h1 class="title clearfix"><span><?php echo $vehicle_brand->name; ?></span></h1>
    <div class="product-block product-grid clearfix">
    <?php
        if($this->vehicle_model->total_vehicle() > 0){
            $config['total_rows'] = $this->vehicle_model->total_vehicle_by_brand($vehicle_brand_id);
            $config['per_page'] = 8;
            ...
            $vehicle = $this->vehicle_model->pagination_vehicle_by_brand($vehicle_brand_id,$config['per_page'], $page);

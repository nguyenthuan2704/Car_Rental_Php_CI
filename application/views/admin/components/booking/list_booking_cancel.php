			...
			<div class="table-responsive">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h2>Danh Sách Đơn Hàng Từ Chối</h2>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="chu">Lý Do Từ Chối</th>
						<th class="chu" colspan="2">Tùy Chọn</th>
					</tr>
				</thead>
				<tbody>
					<?php
					$booking = $this->admin_model->show_booking_cancel();
					...
					<tr class="chu">
						...
						<td><?php echo $book->reason_cancel; ?></td>
						<td>
	                        <a class="btn-success btn" href="<?php echo base_url("booking_confirm/$book->id.html") ?>" onclick="return confirm('Bạn có chắc không?')">Chấp Nhận Đơn</a>
						</td>
						<td>
	                        <a class="btn-success btn" href="<?php echo base_url("huy-don/$book->id.html") ?>" onclick="return confirm('Bạn có muốn xóa không?')">Xóa Đơn</a>
						</td>
					</tr>
					<?php }  ?>
				</tbody>

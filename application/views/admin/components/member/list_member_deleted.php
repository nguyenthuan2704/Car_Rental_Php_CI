	...
	<div class="xs">
		<div class="bs-example4" data-example-id="simple-responsive-table">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<?php
					$user = $this->user_model->show_user_deleted();
					foreach ($user as $us) {
					?>
					<tr class="chu">
						...
						<td class="chu">
						<a class="btn-success btn" href="<?php echo base_url("process-restore-user/$us->id.html"); ?>">Khôi Phục Thành Viên</a>
						</td>
						<td class="chu">
						<a class="btn-success btn" href="<?php echo base_url("process-remove-user/$us->id.html"); ?>" onclick="return confirm('Bạn có muốn xóa không?')">Xóa Vĩnh Viễn Thành Viên</a>
						</td>
					</tr>
					<?php } ?>
				</tbody>

	...
	<div class="xs">
		<div class="bs-example4" data-example-id="simple-responsive-table">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<?php
					$user_admin = $this->user_admin_model->show_user_admin();
					...
					<tr class="chu">
						...
						<td class="chu">
						<a class="btn-success btn" href="<?php echo base_url("update-user-admin-userrole/$us->id.html"); ?>" <?php if($us->id == 1): echo 'disabled'; endif; ?>>
						<?php if($us->id == 1): echo 'Tùy Chọn'; else: echo 'Cập Nhật Cấp Bậc Quản Trị'; endif; ?>
						</a>
						</td>
						<td class="chu">
						<a class="btn-success btn" href="<?php echo base_url("process-delete-user-admin/$us->id.html"); ?>" onclick="return confirm('Bạn có muốn xóa không?')" <?php if($us->id == 1): echo 'disabled'; endif; ?>>
						<?php if($us->id == 1): echo 'Tùy Chọn'; else: echo 'Xóa Quyền Hạn Quản Trị'; endif; ?>
						</a>
						</td>
					</tr>
					<?php } ?>

	...
	<div class="xs">
		<div class="bs-example4" data-example-id="simple-responsive-table">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<?php
					$contact = $this->contact_model->show_contact_examined();
					...
					<tr class="chu">
						...
						<td class="chu">
						<a class="btn-success btn" href="<?php echo base_url("process-delete-contact/$ct->id.html"); ?>" onclick="return confirm('Bạn có muốn xóa không?')">
						Xóa Liên Hệ
						</a>
						</td>
					</tr>
